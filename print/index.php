...
if (isset($_POST['submit'])){
	...
	<div class=WordSection1>
		...
		<p>
			...
			<ol>
				<li>1.	Peraturan Sekretaris Jendral Kementrian Pendidikan, Kebudayaan, Riset, dan Teknologi Nomor: 1 Tahun 2022 tentang Spesifikasi Teknis dan Bentuk, Serta Tata Cara Pengisian, Penggantian, dan Pemusnahan Blanko Ijazah Pendidikan Dasar dan Pendidikan Menengah Tahun Pelajaran 2021/2022;</li>
			...
			<table class="cap">
				<tr> 
					...
					<td width="25%" valign="top">
							Sumedang, <?= $tgl_skl; ?> <br> Kepala Sekolah,
