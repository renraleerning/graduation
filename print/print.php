								...
								<tr>
									<td>
										<div class=WordSection1>
											<center><img width="720" height="150" src="../img/<?= $hsl["kop"] ?>"></center>
											...
											<p>
												Kepala
												<?= $hsl['sekolah'] ?> selaku Ketua Penyelenggara Ujian Sekolah Tahun Pelajaran
												<?= $tahun_ajaran; ?> berdasarkan:
											</p>
											<ol>
												<li>Peraturan Sekretaris Jendral Kementrian Pendidikan, Kebudayaan, Riset, dan Teknologi
													Nomor: 1 Tahun 2022 tentang Spesifikasi Teknis dan Bentuk, Serta Tata Cara
													Pengisian, Penggantian, dan Pemusnahan Blanko Ijazah Pendidikan Dasar dan Pendidikan
													Menengah Tahun Pelajaran 2021/2022;</li>
												<li>Kriteria Kelulusan dari Satuan Pedidikan sesuai dengan peraturan perundang-undangan;
												</li>
												<li>Rapat Pleno Dewan Pendidik tentang Kelulusan Peserta Didik
													<?= $hsl['sekolah'] ?> Tahun Pelajaran
													<?= $tahun_ajaran; ?> pada tanggal 2 Juni 2021.
												</li>
											</ol>
											<br>
											Menerangkan bahwa:
